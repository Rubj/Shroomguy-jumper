...
var player_plot_scene = preload("res://scenes/player_plot.tscn").instantiate()
var player_clay_scene = preload("res://scenes/player_clay.tscn").instantiate()
var player_kukk_scene = preload("res://scenes/player_kukk.tscn").instantiate()
...
func spawn_plot() -> void:
	...
	# edit: seda vist ei olegi üldse vaja lol
